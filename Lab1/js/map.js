...
function worldMap(data) {
    ...
    */
     ...
     */
    function projectlatLng(x,y){
        var pos = leaflet_map.latLngToLayerPoint(new L.LatLng(y, x));
        this.stream.point(pos.x,pos.y);
     }
    ...
    var transform = d3.geoTransform({point:projectlatLng});
